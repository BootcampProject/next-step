    ...
    <div style={Styles.container}>
      {isFinish ? (
        <div style={Styles.finishContainer}>
          ...
          <p style={{ margin: 0 }}>
            You just studied {dataSource.length} term!
          </p>
          <button style={Styles.startOverButton} onClick={handleStartOver}>
            Start over
          </button>
          <button style={Styles.startOverButton} onClick={onFinish}>
            Finish
          </button>
        </div>
      ) : (
          ...
          <div style={Styles.progress}>
            <div style={Styles.bar}>
              <span
                style={{
                  ...Styles.complete,
                  width: `${(step / dataSource.length) * 100}%`,
                }}
              ></span>
            </div>
            <div style={Styles.number}>{`${step}/${dataSource?.length}`}</div>
          </div>
          <div style={Styles.card}>
            <img
              style={Styles.soundButton}
              src="https://www.flaticon.com/svg/static/icons/svg/786/786272.svg"
                ...
                <div style={Styles.cardContent}>
                  {dataSource[step - 1]?.front?.image && (
                    <img
                      width="40%"
                      height="40%"
                      src={dataSource[step - 1]?.front?.image}
                    />
                  )}
                ...
                <div style={Styles.cardContent}>
                  {dataSource[step - 1]?.back?.image && (
                    <img
                      width="40%"
                      height="40%"
                      src={dataSource[step - 1]?.back?.image}
                    />
                  )}
          ...
          <div style={Styles.navigation}>
            <div style={Styles.prevButton} onClick={handlePrev}>
              <img
                width="100%"
                height="100%"
                src="https://www.flaticon.com/svg/static/icons/svg/318/318276.svg"
              />
            </div>
            <div style={Styles.nextButton} onClick={handleNext}>
              <img
                width="100%"
                height="100%"
                src="https://www.flaticon.com/svg/static/icons/svg/467/467152.svg"
              />
            </div>
          </div>
        </div>
